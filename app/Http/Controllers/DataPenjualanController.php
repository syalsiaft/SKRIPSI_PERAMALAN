...
class DataPenjualanController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($jenis_obat) {
            $penjualan->where('jenis_obat', $jenis_obat);
        }
        ...
        return view('pages.data-penjualan.index', compact('penjualan', 'bulanList', 'jenis', 'chartData', 'obatList'));
    }

    public function create()
    {
        $obatList = DataObat::all();
        return view('pages.data-penjualan.create', compact('obatList'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('pages.data-penjualan.show', compact('penjualan'));
    }
    ...
    public function edit($id)
    {
        $penjualan = DataPenjualan::findOrFail($id);
        $obatList = DataObat::all();
        return view('pages.data-penjualan.edit', compact('penjualan', 'obatList'));
    }
